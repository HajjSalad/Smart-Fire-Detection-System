 ...
 * @brief MODBUS RTU register map for STM32 sensor node
 * 
...
#define SCALE_HUMI                  100U    /* %RH   × 100  */
#define SCALE_PRES                  10U     /* hPa   × 10   */
#define SCALE_VOC                   1U      /* Ω     × 1    */
#define SCALE_CO2                   1U      /* ppm   × 1    */
#define SCALE_PM25                  10U     /* µg/m³ × 10   */
#define SCALE_FLAME                 1U      /* 0/1   × 1    */
